  ...
  return (
    <div>
      <header className="relative flex items-center justify-center h-screen mb-12 overflow-hidden">
        <div className="absolute left-0 top-0 z-30 text-white text-6xl font-bold bg-transparent">
            BitOverflow
        </div>
        ...
        <video autoPlay muted playsInline className="absolute z-10 w-auto min-w-full min-h-full max-w-none" >
